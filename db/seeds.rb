...
hym_category = Category.create(name: 'Herramientas')
...
dsf_category = Category.create(name: 'Disfraces')
...
car_category = Category.create(name: 'Vehiculos')
...
wmn_category = Category.create(name: 'Moda Mujer')
...
elec_category = Category.create(name: 'Electronica')
...
evts_category = Category.create(name: 'Eventos')
...
man_category = Category.create(name: 'Hombre')
...
maq_category = Category.create(name: 'Maquinaria')
maq_category.picture.attach(io: maq_file, filename: 'XYNjhbQ9sb4.jpg', content_type: 'image/jpg')
maq_category.save!

# Adding two users
puts "Creando usuario 1"
user1 = User.create(first_name: "Alberto", last_name: "Armani", email: "albertoccs@go.com", password: "12345678")
puts "Creando usuario 2"
user2 = User.create(email: "admin@go.com", password: "12345678")
...
5.times do
  ...
  article.save
  a += 1
  puts "Creando articulo #{a} de usuario 1"
end

# Adding 5 Articles to user 2
a = 0 
5.times do
  article = Article.create(
  name:    "Article #{a+1}",
...
article.save
a += 1
puts "Creando articulo #{a} de usuario 2"
end
